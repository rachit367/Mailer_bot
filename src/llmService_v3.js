...
async function prepareEmailContent(row, resumeText, companyContext = '') {
    ...
    const response = await getLLMResponse([
        {
            role: "system",
            content: "You generate ready-to-send cold emails as JSON. The output is sent directly without human review. Any placeholder, bracket, or unfilled template variable will cause embarrassment — output only real, final text that follows the supplied template structure exactly."
        },
